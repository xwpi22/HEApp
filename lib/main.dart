  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      ...
      builder: (context, child) => MaterialApp(
        ...
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: Color(0xFF2E609C)),
          appBarTheme: AppBarTheme(
            ...
            titleTextStyle: Theme.of(context).textTheme.titleLarge!.copyWith(
              ...
              color: Theme.of(
                context,
              ).colorScheme.onSecondary, // Ensure visibility
            ),
            iconTheme: IconThemeData(color: Colors.white, size: 28.w),
          ),
          ...
          buttonTheme: const ButtonThemeData(buttonColor: Color(0xFF2E609C)),
